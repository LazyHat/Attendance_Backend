...
interface UsersRepository {
    ...
    suspend fun registerTeacher(teacher: TeacherCreate): Boolean
...
class UsersRepositoryImpl(
    ...
    override suspend fun registerTeacher(teacher: TeacherCreate): Boolean = teachersService.create(teacher)
